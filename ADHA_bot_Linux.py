...
class Commands():
    ...
    async def wipe(ctx):
        ...
        subprocess.call([r'/home/r00t-n0v4/Desktop/Discordbot/scripts/wipe.bat'])
    ...
    async def test(ctx):
        ...
        subprocess.call([r'/home/r00t-n0v4/Desktop/Discordbot/scripts/test.bat'])
    ...
    async def ipinfo(ctx, ipadd):
        ...
        with open("whois.txt", "w") as f:
                    print(result, file=f)
        await ctx.author.send(file = discord.File(r'/home/r00t-n0v4/Desktop/Discordbot/whois.txt'))
        ...
        with open("sonar_all.txt", "r") as infile, open ("sonar.txt", "w") as outfile:
             ...
             data = data.replace(",", "\n")
             outfile.write(data)
        sonar_file = "/home/r00t-n0v4/Desktop/Discordbot/sonar.txt"
        ...
        ics_services = sho_key.count('tag:ics')
        print('Industrial Control Systems: {}'.format(ics_services['total']))
        await ctx.author.send('Industrial Control Systems: {}'.format(ics_services['total']))
    ...
    async def token(ctx):
        ...
        await ctx.author.send(f'''Here are your RSA keys
        Note: Do not lose that private key''')
        await ctx.author.send(file = discord.File(r'/home/r00t-n0v4/Desktop/Discordbot/rsa_public.txt'))
        await ctx.author.send(file = discord.File(r'/home/r00t-n0v4/Desktop/Discordbot/rsa_private.txt'))
        await ctx.author.send("These Files have now been earased forever")
        os.remove('rsa_public.txt')
        os.remove('rsa_private.txt')
    
    #wifi networks near Bagley
    ...
    async def wifinear(ctx):
        ...
        wifinear_path = "/home/r00t-n0v4/Desktop/Discordbot/wifinear.txt"
    ...
    async def searchuser(ctx, user_name):
        ...
        path = '/home/r00t-n0v4/sherlock/sherlock'
    ...
    async def domaininfo(ctx, domname):
        ...
        file_path = '/home/r00t-n0v4/Desktop/Discordbot/domaininfo.txt'
        await ctx.author.send(file = discord.File(file_path))
        os.remove(file_path)
        ...
        file_whois = '/home/r00t-n0v4/Desktop/Discordbot/whois.txt'
    ...
    async def subdom(ctx, domain):
        ...
        await ctx.author.send("Here is what we found using security trails: ")
        Sec_fileSubdom = '/home/r00t-n0v4/Desktop/Discordbot/subdomain_find.txt'
    ...
    async def weather(ctx, location):
        ...
        with open("Weather_test.txt", "r") as infile, open ("Weather.txt", "w") as outfile:
             ...
             data = data.replace(",", "\n")
             outfile.write(data)
        weather_file = '/home/r00t-n0v4/Desktop/Discordbot/Weather.txt'
        weather_test = '/home/r00t-n0v4/Desktop/Discordbot/Weather_test.txt'
        await ctx.author.send(file = discord.File(weather_file))
        os.remove("Weather_file.txt")
        os.remove("Weather_test.txt")
    ...
    async def exchange(ctx):
        ...
        with open("Exchange.txt", "r") as infile, open("Exchangerates.txt", "w") as outfile:
            ...
            data = data.replace(",","\n")
            outfile.write(data)
        path = "/home/r00t-n0v4/Desktop/Discordbot/Exchangerates.txt"  
    ...
    async def crypto(ctx):
        ...
        with open("crypto.txt", "r") as infile, open("crypto_rate.txt", "w") as outfile:
            ...
            data = data.replace(",","\n")
            outfile.write(data)
        path = "/home/r00t-n0v4/Desktop/Discordbot/crypto_rate.txt"
